...
const styles = StyleSheet.create({
  ...
  htitle: { flex: 1, textAlign: 'center', ...Type.screenTitle, color: '#0D0D0D' },
  ...
  serviceChipName: { ...Type.listPrimary, color: '#0D0D0D' },
  ...
  clientTxt: { ...Type.listPrimary, color: '#0D0D0D', flex: 1 },
  clientPh: { ...Type.secondary, color: '#0D0D0D', flex: 1 },
  saveBtn: {
    marginTop: 28,
  ...
  stockName: { ...Type.listPrimary, color: '#0D0D0D', flex: 1 },
  iosPickerRoot: {
    flex: 1,
    justifyContent: 'flex-end',
    backgroundColor: 'rgba(0,0,0,0.35)',
